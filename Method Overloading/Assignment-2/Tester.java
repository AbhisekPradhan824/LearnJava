class Tester {
	...
	public static void main(String[] args) {
		...
		Triangle triangle4 = new Triangle(3.0, 3.0, -1.0, -1.0, 4.0, -4.0);
		...
		System.out.println("Perimeter of triangle4 is "+triangle4.calculatePerimeter());
		System.out.println("Area of triangle4 is "+triangle4.calculateArea());
